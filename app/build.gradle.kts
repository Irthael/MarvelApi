...
val properties = Properties().apply {
    load(rootProject.file("privatekey.properties").reader())
}

val MyPrivateKey = properties["MyPrivateKey"]!!
val MyPublickey = properties["MyPublickey"]

android {
    namespace = "com.dani.marvelapi"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.dani.marvelapi"
        minSdk = 34
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField("String", "PUBLIC_API_KEY", "\"$MyPrivateKey\"")
        buildConfigField("String", "PRIVATE_API_KEY", "\"$MyPublickey\"")
